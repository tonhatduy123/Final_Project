      ...
      <nav class="nav-menu d-none d-lg-block" id='top-nav'>
        <ul>
          <li class="nav-home"><a href="./index.php?page=home">Home</a></li>
           ...
           <li class="nav-booked"><a href="./index.php?page=booked">Manage Booked List</a></li>
          <li class="drop-down nav-bus nav-location"><a href="#">Manage Maintenance</a>
            <ul>
              <li><a href="./index.php?page=bus">Manage Bus List</a></li>
              <li><a href="./index.php?page=location">Manage Location List</a></li>
          ...
          <li class="drop-down nav-user"><a href="#"><?php echo $_SESSION['login_name'] ?> </a>
             <ul>
              <li><a href="./index.php?page=user">Manage Staff</a></li>
