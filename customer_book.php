...
<div class="container-fluid">
	<form id="manage_book">
		<div class="col-md-12">
			...
			<p><b>Start Time</b>: <?php echo date('M d,Y h:i A',strtotime($meta['departure_time'])) ?></p>
			<p><b>End Time :</b> <?php echo date('M d,Y h:i A',strtotime($meta['eta'])) ?></p>
			...
			<div class="form-group mb-2">
				...
				<input type="text" class="form-control"  required id="name" name="name" value="<?php echo isset($bmeta['name']) ? $bmeta['name'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="address" class="control-label">Address</label>
				<input type="text" class="form-control" required id="address" name="address" value="<?php echo isset($bmeta['address']) ? $bmeta['address'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="qty" class="control-label">Phone</label>
				<input type="number" maxlength="10" class="form-control text-right" required id="phone" name="phone" value="<?php echo isset($bmeta['phone']) ? $bmeta['phone'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="confirm_from" class="control-label">Confrim From</label>
				<input type="text" class="form-control" required id="confirm_from" name="confirm_from" value="<?php echo isset($bmeta['confirm_from']) ? $bmeta['confirm_from'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="confirm_to" class="control-label">Confrim To</label>
				<input type="text" class="form-control" required id="confirm_to" name="confirm_to" value="<?php echo isset($bmeta['confirm_to']) ? $bmeta['confirm_to'] : '' ?>">
			</div>
			<div class="form-group mb-2">
				<label for="qty" class="control-label">Quantity</label>
				<input type="number" maxlength="4" class="form-control text-right" required id="qty" name="qty" value="<?php echo isset($bmeta['qty']) ? $bmeta['qty'] : '' ?>">
			</div>
